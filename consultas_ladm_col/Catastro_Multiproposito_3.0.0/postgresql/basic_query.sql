WITH
 ...
 terrenos_seleccionados AS (
	SELECT 8312 AS ue_op_terreno WHERE '8312' <> 'NULL'
		UNION
 ...
 predios_seleccionados AS (
	SELECT col_uebaunit.baunit as t_id FROM test_ladm_col_queries.col_uebaunit WHERE col_uebaunit.ue_op_terreno = 8312 AND '8312' <> 'NULL'
		UNION
